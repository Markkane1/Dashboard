    ...
    <nav className="bg-white h-[4.375rem] shadow-[0_0.15rem_1.75rem_0_rgba(58,59,69,0.15)] flex items-center justify-between px-6 z-10 sticky top-0">
      ...
      <ul className="flex items-center ml-auto">
        ...
        <li className="sm:hidden mr-2">
          <button className="text-[#d1d3e2] hover:text-[#b7b9cc] p-2 flex items-center justify-center rounded-full">
        ...
        <li className="relative mx-2">
          <button className="text-[#d1d3e2] hover:text-[#b7b9cc] p-2 flex items-center justify-center rounded-full relative">
        ...
        <li className="relative">
          <button className="flex items-center gap-2 text-gray-600 hover:text-gray-800 focus:outline-none">
